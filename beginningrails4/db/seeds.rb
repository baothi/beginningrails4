...
user = User.create :email => 'baothi246@gmail.com', :password => '123456'
# user = User.create :email => 'thi@gmail.com', :password => '123456'
# user = User.create :email => 'bao246@gmail.com', :password => '123456'
